...
try {
  ...
  $pdo->exec("CREATE TABLE IF NOT EXISTS reservation (
        ...
        total_area DECIMAL(10, 2) AS (width * height),
        start_at DATETIME NOT NULL,
        end_at DATETIME NOT NULL,
        total_occupied_time DECIMAL(10, 2) AS (TIMESTAMPDIFF(HOUR, start_at, end_at)),
        price_per_hour DECIMAL(10, 2) AS (SELECT price_per_hour FROM studium WHERE studium_id = reservation.studium_id),
        total_price DECIMAL(10, 2) AS (price_per_hour * total_occupied_time),
